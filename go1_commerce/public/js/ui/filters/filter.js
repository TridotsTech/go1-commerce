frappe.ui.CustomFilter = class {
	constructor(opts) {
		...
		this.conditions = [
			...
			["count_l", __("Count(<)")],
			["count_e", __("Count(=)")],
			["average_g", __("Average(>)")],
			["average_l", __("Average(<)")],
			["average_e", __("Average(=)")],
			[">", ">"],
			["<", "<"],
			[">=", ">="],
			["<=", "<="],
		...
		this.invalid_condition_map = {
			Date: ['like', 'not like', 'sum_l', 'average_l', 'sum_g', 'average_g','sum_e', 'average_e'],
			Datetime: ['like', 'not like', 'sum_l', 'average_l', 'sum_g', 'average_g','sum_e', 'average_e'],
			Data: ['Between', 'Previous', 'Next', 'sum_l', 'average_l', 'sum_g', 'average_g','sum_e', 'average_e'],
			Select: ['like', 'not like', 'Between', 'Previous', 'Next', 'sum_l', 'average_l', 'sum_g', 'average_g','sum_e', 'average_e'],
			Link: ["Between", 'Previous', 'Next', '>', '<', '>=', '<=', 'sum_l', 'average_l', 'sum_g', 'average_g','sum_e', 'average_e'],
			Currency: ["Between", 'Previous', 'Next'],
			Color: ["Between", 'Previous', 'Next', 'sum_l', 'average_l', 'sum_g', 'average_g','sum_e', 'average_e'],
	...
	make() {
		...
		this.filter_edit_area = $(frappe.render_template("custom_edit_filter", {
