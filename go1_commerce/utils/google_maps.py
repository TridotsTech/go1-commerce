...
def get_geolocation(address):
	try:
		...
		frappe.log_error(frappe.get_traceback(), 'go1_commerce.utils.google_maps.get_geolocation')
...
def reverse_geocode(latitude, longitude):
	try:
		...
		frappe.log_error(frappe.get_traceback(), 'go1_commerce.utils.google_maps.reverse_geocode')
