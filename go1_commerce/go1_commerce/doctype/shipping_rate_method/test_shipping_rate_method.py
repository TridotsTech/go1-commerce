...
class TestShippingRateMethod(unittest.TestCase):
	def test_shipping_creation(self):
		...
		rate_shipping = make_shipping_rate_method( "Fixed Rate Shipping", 1)
		rate_shipping1 = make_shipping_rate_method( "Shipping By Weight", 0)
		rate_shipping2 = make_shipping_rate_method( "Shipping By Total", 0)
...
def make_shipping_rate_method( rate_method_name, is_active):
	...
	rate_method.save()
	method_name = frappe.db.get_value("Shipping Method",{"business":''}, "name")
