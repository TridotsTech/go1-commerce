...
class TestOrder(unittest.TestCase):
	...
	def test_order_creation(self):
		...
		prd1 = frappe.get_value("Product",{"item":"Test Product 1", "restaurant":business1}, "name")
		prd2 = frappe.get_value("Product",{"item":"Test Product 2", "restaurant":business2}, "name")
		order1 = make_order(business=business1, product=prd1, customer=customer1, shipping_charge=0, tax=0, attr=0, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=0, delivery_discount=0)
		order2 = make_order(business=business1, product=prd1, customer=customer1, shipping_charge=1, tax=0, attr=0, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=0, delivery_discount=0)
		order3 = make_order(business=business1, product=prd1, customer=customer1, shipping_charge=1, tax=1, attr=0, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=0, delivery_discount=0)
		order4 = make_order(business=business2, product=prd2, customer=customer2, shipping_charge=0, tax=1, attr=0, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=0, delivery_discount=0)
		order5 = make_order(business=business1, product=prd1, customer=customer1, shipping_charge=0, tax=0, attr=0, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=0, delivery_discount=0)
		order6 = make_order(business=business2, product=prd2, customer=customer1, shipping_charge=0, tax=0, attr=1, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=0, delivery_discount=0)
		order7 = make_order(business=business2, product=prd2, customer=customer1, shipping_charge=0, tax=0, attr=0, status="Packed", shipping_status="Packed", payment_status="Pending", subtotal_discount=0, delivery_discount=0)
		order8 = make_order(business=business2, product=prd2, customer=customer1, shipping_charge=0, tax=0, attr=0, status="Shipped", shipping_status="Shipped", payment_status="Pending", subtotal_discount=0, delivery_discount=0)
		order9 = make_order(business=business2, product=prd2, customer=customer1, shipping_charge=0, tax=0, attr=0, status="Delivered", shipping_status="Delivered", payment_status="Pending", subtotal_discount=0, delivery_discount=0)
		order10 = make_order(business=business2, product=prd2, customer=customer1, shipping_charge=0, tax=0, attr=0, status="Completed", shipping_status="Delivered", payment_status="Paid", subtotal_discount=0, delivery_discount=0)
		order11 = make_order(business=business2, product=prd2, customer=customer1, shipping_charge=0, tax=0, attr=0, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=1, delivery_discount=0)
		order12 = make_order(business=business1, product=prd1, customer=customer1, shipping_charge=1, tax=1, attr=0, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=1, delivery_discount=0)
		order13 = make_order(business=business1, product=prd1, customer=customer1, shipping_charge=1, tax=0, attr=0, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=1, delivery_discount=0)
		order14 = make_order(business=business1, product=prd1, customer=customer1, shipping_charge=0, tax=1, attr=0, status="Placed", shipping_status="Pending", payment_status="Pending", subtotal_discount=1, delivery_discount=0)
		order_doc = frappe.get_doc("Order", order1).reload()
		order_doc1 = frappe.get_doc("Order", order2).reload()

def make_order(business, product, customer, shipping_charge, tax, attr, status, shipping_status, payment_status, subtotal_discount, delivery_discount):
	...
	payment_name = frappe.db.get_value("Payment Method",{"business":business}, "name")
	shipping_method_name = frappe.db.get_value("Shipping Method",{"business":business}, "shipping_method_name")
	payment_method_name = frappe.db.get_value("Payment Method",{"business":business}, "payment_method")
	...
	tax1 = ''
	if tax == 1:
		tax1 = calculate_item_tax(business,cart1)
	...
	order.append("order_item", {"business": business, "item": item_info.name, "item_name":item_info.item, "price": price, "attribute_description":attribute_description, "attribute_ids":attribute_ids, "quantity": 1, "shipping_status":shipping_status, "amount": price, "tax":tax_amt})
	order.insert()
...
def calculate_item_tax(business, item):
		tax_info = None
		tax = ''
		tax_breakup = ''
