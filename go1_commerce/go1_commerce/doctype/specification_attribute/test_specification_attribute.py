...
class TestSpecificationAttribute(unittest.TestCase):
	def test_attribute_creation(self):
		...
		specification = make_specification("Test Specification Attribute 1", business1)
		specification1 = make_specification("Test Specification Attribute 2", business2)
...
def make_specification(name, business=None):
	if not frappe.db.get_value("Specification Attribute", { "attribute_name": name, "business":business}):
		...
		return frappe.get_value("Specification Attribute", { "attribute_name": name, "business":business}, "name")
